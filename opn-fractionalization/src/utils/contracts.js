...
export const FRACTIONALIZATION_ABI = [
  ...
  // Request Management
  "function createFractionalizationRequest(string _assetType, string _assetName, string _assetDescription, string _assetImageUrl, uint256 _totalFractions, uint256 _pricePerFraction, bool _requiresPurchaserKYC)",
  ...
  // View functions
  "function requests(uint256) view returns (uint256 requestId, address proposer, string assetType, string assetName, string assetDescription, string assetImageUrl, uint256 totalFractions, uint256 pricePerFraction, bool requiresPurchaserKYC, uint8 status, uint256 tokenId, uint256 timestamp)",
  "function assetDetails(uint256) view returns (uint256 tokenId, uint256 requestId, address creator, uint256 totalSupply, uint256 availableSupply, uint256 pricePerFraction, bool requiresPurchaserKYC, bool isActive, uint256 totalRevenue)",
...
export const CONTRACTS = {
  sage: {
    fractionalization: import.meta.env.VITE_FRACTIONALIZATION_CONTRACT || '0x020A7AeE2e541f15e12628785E57FeD1CC099Fa9',
    kyc: import.meta.env.VITE_KYC_REGISTRY_CONTRACT || '0x097774d0Ae34988C108b0609298Abe993B8e4b39',
  },
  mainnet: {
